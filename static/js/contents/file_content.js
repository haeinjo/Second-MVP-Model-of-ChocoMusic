...
const filePanel = document.querySelector(".file__panel");
const panelScraper = document.querySelector(".panel__scraper");


window.onload = initContentFile();

function initContentFile() {
    if (window.File && window.FileList && window.FileReader)
        setFileDAD();
    panelScraper.addEventListener("click", clickPanelScraper);
}
