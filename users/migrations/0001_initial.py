    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('borough', models.CharField(blank=True, default='', max_length=16)),
                ...
                ('login_method', models.CharField(choices=[('kakao', 'Kakao'), ('google', 'Google'), ('email', 'Email')], default='email', max_length=8)),
                ('genres', models.ManyToManyField(blank=True, related_name='users', to='core.Genre')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('positions', models.ManyToManyField(blank=True, related_name='users', to='core.Position')),
